...
Creating a sitemap
Deciding website features and content
...
Content can be made more relevant
The website becomes more effective
Without knowing the audience, the website may fail to meet user expectations
...
The client should not skip the testing part. It is very important to make sure the e-commerce site works right and is safe. If we do not test it we will have problems later. The e-commerce site is like a store. You have to make sure the store is safe and works right before you open it. That is what testing is, for.

Skipping the testing phase might seem like it saves you time and money.. It can cause big problems later on when the website is live. The website is live. People are using it. Testing is important because it helps find mistakes and security issues before anyone gets to the website. Testing finds errors and bugs. If you do not test the website, customer information like details and payment information is not safe. The customer data is at risk because it is not protected. Testing the website is necessary to protect customer data, like details and payment information.

You might have some problems with your website. For example the shopping cart may not work right. People may have trouble paying when they check out. The website might also not work well on browsers or, on phones. If people have these kinds of problems they may not trust the website anymore. They will stop using the shopping cart on the website. They will stop using the website.

Testing is really important, for the website. It makes sure the website is secure user-friendly and reliable. If you skip testing it can cause loss. You will also have user experience and damage to the companys reputation. Testing the website is crucial to avoid these problems. The website needs to be tested to make sure it is secure and easy to use
...
To avoid this problem we should have made a sitemap and a design prototype first. Then we should have shared the sitemap and the design prototype with the client.

We should have waited for the client to give us feedback and approval on the sitemap and the design prototype.

After the client approved the sitemap and the design prototype we should have started coding.

Making a plan and talking to the client are very important to avoid issues, like this with the sitemap and the design prototype
...
Things we do in this phase are updating the website with stuff like exam schedules and notices all the time. We also fix mistakes. Make sure the website works properly and is secure. Maintenance is also about watching what users say about the website and making changes to make it better. We do things like improving performance and making sure the website is safe for users. Maintenance of the website includes checking what users think and making changes, to the website to make it work better for the users of the website.

Since exam schedules were not updated, students lost trust in the website and stopped visiting it. Proper maintenance would have ensured that information remained current and the website continued to serve its purpose effectively.